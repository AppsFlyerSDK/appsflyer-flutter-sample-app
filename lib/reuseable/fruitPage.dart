...
class FruitPage extends StatelessWidget {
  ...
  const FruitPage({super.key, required this.sub1Value, required this.fruit});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isDeeplinkAndCurrentPage(fruit)
          ? DeeplinkData(
              fruit: fruit,
              sub1Value: sub1Value,
            )
...
class DeeplinkData extends StatelessWidget {
  final String fruit, sub1Value;
  const DeeplinkData({super.key, required this.sub1Value, required this.fruit});
      ...
      children: [
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              for (String key
                  in AppsflyerSDKManager().deepLinkData!.clickEvent.keys)
                Wrap(
                  children: [
                    Text(
                      "$key: ",
...
bool isDeeplinkAndCurrentPage(fruit) {
  return AppsflyerSDKManager().deepLinkData?.deepLinkValue == fruit ||
